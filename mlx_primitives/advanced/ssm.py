...
def selective_scan(
    ...
    """Selective scan operation for state space models.
    ...
    delta_A = mx.exp(delta_A)

    delta_B = delta[..., None] * B[..., None, :]  # (batch, seq, d_inner, d_state)
    ...
    for t in range(seq_len):
        ...
        y = mx.sum(h * C[:, t, None, :], axis=-1)  # (batch, d_inner)
        outputs.append(y)
